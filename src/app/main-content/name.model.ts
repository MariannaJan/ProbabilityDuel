export class NameGenerator {
    generateName() {
        ...
        const namesArr = ['Aakheperkare', 'Addaya', 'Ahhotpe', 'Ahmes', 'Ahmose',
...
/*
A very, very simple name generator.
*/
        firstName = namesArr[Math.floor(Math.random() * namesArr.length)];
        lastName = namesArr[Math.floor(Math.random() * namesArr.length)];
